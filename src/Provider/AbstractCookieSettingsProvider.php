...
/**
 * @deprecated Please use AbstractPasetoCookieSettingsProvider instead
 */
abstract class AbstractCookieSettingsProvider extends AbstractBaseCookieSettingsProvider
{
    private $footer;
